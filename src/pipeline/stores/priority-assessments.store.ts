...
export function mapPriorityRowToAssessment(row: PriorityAssessmentRow): PriorityAssessment {
  return {
    ...
    score_explanation: row.score_explanation as unknown as PriorityAssessment['score_explanation'],
    ...
    score_delta: row.score_delta as unknown as PriorityAssessment['score_delta'],
